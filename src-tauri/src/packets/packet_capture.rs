...
pub async fn packet_handler(known_server: &mut Option<Server>, tcp_reassembler: &mut TCPReassembler, packet_sender: &tokio::sync::mpsc::Sender<(packets::opcodes::Pkt, Vec<u8>)>, network_slices: SlicedPacket<'_>) {
    // info!("{}", line!());
